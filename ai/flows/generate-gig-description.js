...
exports.generateGigDescription = generateGigDescription;
/**
...
var GenerateGigDescriptionInputSchema = genkit_2.z.object({
    title: genkit_2.z.string().describe('The title of the gig.'),
    keywords: genkit_2.z.array(genkit_2.z.string()).describe('A list of keywords related to the gig.'),
});
var GenerateGigDescriptionOutputSchema = genkit_2.z.object({
    description: genkit_2.z.string().describe('The generated gig description.'),
});
function generateGigDescription(input) {
    return __awaiter(this, void 0, void 0, function () {
        return __generator(this, function (_a) {
            return [2 /*return*/, generateGigDescriptionFlow(input)];
        });
    });
}
...
var generateGigDescriptionFlow = genkit_1.ai.defineFlow({
