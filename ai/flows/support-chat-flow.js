...
var SupportChatInputSchema = genkit_2.z.object({
    history: genkit_2.z.array(genkit_2.z.object({
        role: genkit_2.z.enum(['user', 'model']),
        content: genkit_2.z.string(),
    })).describe('The conversation history between the user and the AI.'),
});
var SupportChatOutputSchema = genkit_2.z.object({
    response: genkit_2.z.string().describe('The AI-generated response to the user.'),
});
function supportChat(input) {
    return __awaiter(this, void 0, void 0, function () {
        return __generator(this, function (_a) {
            return [2 /*return*/, supportChatFlow(input)];
        });
    });
}
...
var supportChatFlow = genkit_1.ai.defineFlow({
