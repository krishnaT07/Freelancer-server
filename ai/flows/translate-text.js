...
var TranslateTextInputSchema = genkit_2.z.object({
    text: genkit_2.z.string().describe('The text to be translated.'),
    targetLanguage: genkit_2.z.string().describe('The target language for the translation (e.g., "Spanish", "French", "Japanese").'),
});
var TranslateTextOutputSchema = genkit_2.z.object({
    translation: genkit_2.z.string().describe('The translated text.'),
});
function translateText(input) {
    return __awaiter(this, void 0, void 0, function () {
        return __generator(this, function (_a) {
            return [2 /*return*/, translateTextFlow(input)];
        });
    });
}
...
var translateTextFlow = genkit_1.ai.defineFlow({
