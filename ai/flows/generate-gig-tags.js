...
exports.generateGigTags = generateGigTags;
/**
...
var GenerateGigTagsInputSchema = genkit_2.z.object({
    title: genkit_2.z.string().describe('The title of the gig.'),
    description: genkit_2.z.string().describe('The description of the gig.'),
});
var GenerateGigTagsOutputSchema = genkit_2.z.object({
    tags: genkit_2.z.array(genkit_2.z.string()).describe('An array of tags generated for the gig.'),
});
function generateGigTags(input) {
    return __awaiter(this, void 0, void 0, function () {
        return __generator(this, function (_a) {
            return [2 /*return*/, generateGigTagsFlow(input)];
        });
    });
}
...
var generateGigTagsFlow = genkit_1.ai.defineFlow({
